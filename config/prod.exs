...
# PhoenixStarterWeb.Endpoint.init/2 when load_from_system_env is
...
config :phoenix_starter, PhoenixStarterWeb.Endpoint,
  ...
  url: [host: "cmacweb.com", port: 443],
  https: [:inet6, port: 443, keyfile: "${SSL_KEY_PATH}", certfile: "${SSL_CERT_PATH}"],
  force_ssl: true,
