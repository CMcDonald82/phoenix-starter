...
4. Install frontend dependencies (via Yarn) 
```
...
3. Make sure you've set the local environment variable PHOENIX_STARTER_PROD_HOST to be the domain name you have set up for the server (this should already have been done in step 4 of the 'Setup' instructions, above)
